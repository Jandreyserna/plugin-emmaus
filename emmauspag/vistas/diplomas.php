...
<div class="modal-diplomado">
    <!-- Modal costos de curso-->
    <div class="modal fade" id="update-note-diploma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
